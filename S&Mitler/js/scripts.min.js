...
$(function(){$("#my-menu").mmenu({extensions:["widescreen","theme-black","fx-menu-slide","pagedim-black","position-right"],navbar:{title:'<img src="img/logo.svg" alt="alt">'}});var e=$("#my-menu").data("mmenu");e.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),e.bind("close:before",function(e){$(".hamburger").removeClass("is-active")}),$(".carousel-services").owlCarousel({nav:!0,smartSpeed:700,navText:['<i class="fas fa-angle-double-left"></i>','<i class="fas fa-angle-double-right"></i>'],responsiveClass:!0,dots:!1,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),setTimeout(function(){$(".carousel-services-item").each(function(){var e=$(this);thsh=e.find(".carousel-services-content").outerHeight(),e.find(".carousel-services-image").css("min-height",thsh)})},100),$(".carousel-services-compositon .h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section .h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),$("select").selectize({}),$(".carousel-services-content").equalHeights(),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClasss("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removaClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(".reviews").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!1,dots:!0}),$(".partners").owlCarousel({loop:!0,items:4,smartSpeed:700,nav:!0,dots:!1,navText:['<i class="fas fa-angle-left"></i>','<i class="fas fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:4}}}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html,body").stop().animate({scrollTop:0},"slow","swing")}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")})});